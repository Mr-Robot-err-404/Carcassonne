...
export function Intro() {
    return (
        <>
            <p>Based on the popular board game created by Klaus-Jürgen Wrede, Carcasssonne is a classic game of simple strategy. Here are the three main components of the game:</p>
